...
data_loader = DataLoader(data_dataset,batch_size=batch_size,shuffle=True,num_workers=0)
phys_loader = DataLoader(phys_dataset, batch_size=batch_size, shuffle=True, num_workers=0)
ic_loader = DataLoader(ic_dataset,batch_size=batch_size, shuffle=True, num_workers=0)
bc_loader = DataLoader(bc_dataset,batch_size=batch_size, shuffle=True, num_workers=0)
